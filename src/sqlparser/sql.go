//line kingshard/sqlparser/sql.y:20
package sqlparser
...
//line kingshard/sqlparser/sql.y:45
...
yydefault:
	...
	case 1:
		...
		//line kingshard/sqlparser/sql.y:193
		{
			SetParseTree(yylex, yyDollar[1].statement)
		}
	case 2:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:199
		{
			yyVAL.statement = yyDollar[1].selStmt
		}
	case 18:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:220
		{
			yyVAL.selStmt = &SimpleSelect{Comments: Comments(yyDollar[2].bytes2), Distinct: yyDollar[3].str, SelectExprs: yyDollar[4].selectExprs}
		}
	case 19:
		yyDollar = yyS[yypt-12 : yypt+1]
		//line kingshard/sqlparser/sql.y:224
		{
			yyVAL.selStmt = &Select{Comments: Comments(yyDollar[2].bytes2), Distinct: yyDollar[3].str, SelectExprs: yyDollar[4].selectExprs, From: yyDollar[6].tableExprs, Where: NewWhere(AST_WHERE, yyDollar[7].boolExpr), GroupBy: GroupBy(yyDollar[8].valExprs), Having: NewWhere(AST_HAVING, yyDollar[9].boolExpr), OrderBy: yyDollar[10].orderBy, Limit: yyDollar[11].limit, Lock: yyDollar[12].str}
		}
	case 20:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:228
		{
			yyVAL.selStmt = &Union{Type: yyDollar[2].str, Left: yyDollar[1].selStmt, Right: yyDollar[3].selStmt}
		}
	case 21:
		yyDollar = yyS[yypt-8 : yypt+1]
		//line kingshard/sqlparser/sql.y:235
		{
			yyVAL.statement = &Insert{Comments: Comments(yyDollar[2].bytes2), Ignore: yyDollar[3].str, Table: yyDollar[5].tableName, Columns: yyDollar[6].columns, Rows: yyDollar[7].insRows, OnDup: OnDup(yyDollar[8].updateExprs)}
		}
	case 22:
		yyDollar = yyS[yypt-8 : yypt+1]
		//line kingshard/sqlparser/sql.y:239
		{
	...
	case 23:
		...
		//line kingshard/sqlparser/sql.y:251
		{
			yyVAL.statement = &Replace{Comments: Comments(yyDollar[2].bytes2), Table: yyDollar[4].tableName, Columns: yyDollar[5].columns, Rows: yyDollar[6].insRows}
		}
	case 24:
		yyDollar = yyS[yypt-6 : yypt+1]
		//line kingshard/sqlparser/sql.y:255
		{
	...
	case 25:
		yyDollar = yyS[yypt-8 : yypt+1]
		//line kingshard/sqlparser/sql.y:268
		{
			yyVAL.statement = &Update{Comments: Comments(yyDollar[2].bytes2), Table: yyDollar[3].tableName, Exprs: yyDollar[5].updateExprs, Where: NewWhere(AST_WHERE, yyDollar[6].boolExpr), OrderBy: yyDollar[7].orderBy, Limit: yyDollar[8].limit}
		}
	case 26:
		yyDollar = yyS[yypt-7 : yypt+1]
		//line kingshard/sqlparser/sql.y:274
		{
			yyVAL.statement = &Delete{Comments: Comments(yyDollar[2].bytes2), Table: yyDollar[4].tableName, Where: NewWhere(AST_WHERE, yyDollar[5].boolExpr), OrderBy: yyDollar[6].orderBy, Limit: yyDollar[7].limit}
		}
	case 27:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:280
		{
			yyVAL.statement = &Set{Comments: Comments(yyDollar[2].bytes2), Exprs: yyDollar[3].updateExprs}
		}
	case 28:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:284
		{
	...
	case 29:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:288
		{
	...
	case 30:
		yyDollar = yyS[yypt-6 : yypt+1]
		//line kingshard/sqlparser/sql.y:292
		{
			yyVAL.statement = &Set{
	...
	case 31:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:308
		{
			yyVAL.statement = &Begin{}
		}
	case 32:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:312
		{
			yyVAL.statement = &Begin{}
		}
	case 33:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:319
		{
			yyVAL.statement = &Commit{}
		}
	case 34:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:325
		{
			yyVAL.statement = &Rollback{}
		}
	case 35:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:331
		{
			yyVAL.statement = &Admin{Region: yyDollar[2].tableName, Columns: yyDollar[3].columns, Rows: yyDollar[4].insRows}
		}
	case 36:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:335
		{
			yyVAL.statement = &AdminHelp{}
		}
	case 37:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:341
		{
			yyVAL.statement = &UseDB{DB: string(yyDollar[2].bytes)}
		}
	case 38:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:347
		{
			yyVAL.statement = &Truncate{Comments: Comments(yyDollar[2].bytes2), TableOpt: yyDollar[3].str, Table: yyDollar[4].tableName}
		}
	case 39:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:353
		{
			yyVAL.statement = &DDL{Action: AST_CREATE, NewName: yyDollar[4].bytes}
		}
	case 40:
		yyDollar = yyS[yypt-8 : yypt+1]
		//line kingshard/sqlparser/sql.y:357
		{
	...
	case 44:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:377
		{
			yyVAL.statement = &DDL{Action: AST_ALTER, Table: yyDollar[3].bytes, NewName: yyDollar[3].bytes}
		}
	case 45:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:383
		{
			yyVAL.statement = &DDL{Action: AST_RENAME, Table: yyDollar[3].bytes, NewName: yyDollar[5].bytes}
		}
	case 46:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:389
		{
			yyVAL.statement = &DDL{Action: AST_DROP, Table: yyDollar[4].bytes}
		}
	case 47:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:393
		{
			// Change this to an alter statement
	...
	case 48:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:398
		{
			yyVAL.statement = &DDL{Action: AST_DROP, Table: yyDollar[4].bytes}
		}
	case 49:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:403
		{
			SetAllowComments(yylex, true)
		}
	case 50:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:407
		{
	...
	case 51:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:413
		{
			yyVAL.bytes2 = nil
		}
	case 52:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:417
		{
			yyVAL.bytes2 = append(yyDollar[1].bytes2, yyDollar[2].bytes)
		}
	case 53:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:423
		{
			yyVAL.str = AST_UNION
		}
	case 54:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:427
		{
			yyVAL.str = AST_UNION_ALL
		}
	case 55:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:431
		{
			yyVAL.str = AST_SET_MINUS
		}
	case 56:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:435
		{
			yyVAL.str = AST_EXCEPT
		}
	case 57:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:439
		{
			yyVAL.str = AST_INTERSECT
		}
	case 58:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:444
		{
			yyVAL.str = ""
		}
	case 59:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:448
		{
			yyVAL.str = AST_DISTINCT
		}
	case 60:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:454
		{
			yyVAL.selectExprs = SelectExprs{yyDollar[1].selectExpr}
		}
	case 61:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:458
		{
			yyVAL.selectExprs = append(yyVAL.selectExprs, yyDollar[3].selectExpr)
		}
	case 62:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:464
		{
			yyVAL.selectExpr = &StarExpr{}
		}
	case 63:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:468
		{
			yyVAL.selectExpr = &NonStarExpr{Expr: yyDollar[1].expr, As: yyDollar[2].bytes}
		}
	case 64:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:472
		{
			yyVAL.selectExpr = &StarExpr{TableName: yyDollar[1].bytes}
		}
	case 65:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:478
		{
			yyVAL.expr = yyDollar[1].boolExpr
		}
	case 66:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:482
		{
			yyVAL.expr = yyDollar[1].valExpr
		}
	case 67:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:487
		{
			yyVAL.bytes = nil
		}
	case 68:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:491
		{
			yyVAL.bytes = yyDollar[1].bytes
		}
	case 69:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:495
		{
			yyVAL.bytes = yyDollar[2].bytes
		}
	case 70:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:501
		{
			yyVAL.tableExprs = TableExprs{yyDollar[1].tableExpr}
		}
	case 71:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:505
		{
			yyVAL.tableExprs = append(yyVAL.tableExprs, yyDollar[3].tableExpr)
		}
	case 72:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:511
		{
			yyVAL.tableExpr = &AliasedTableExpr{Expr: yyDollar[1].smTableExpr, As: yyDollar[2].bytes, Hints: yyDollar[3].indexHints}
		}
	case 73:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:515
		{
			yyVAL.tableExpr = &ParenTableExpr{Expr: yyDollar[2].tableExpr}
		}
	case 74:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:519
		{
			yyVAL.tableExpr = &JoinTableExpr{LeftExpr: yyDollar[1].tableExpr, Join: yyDollar[2].str, RightExpr: yyDollar[3].tableExpr}
		}
	case 75:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:523
		{
			yyVAL.tableExpr = &JoinTableExpr{LeftExpr: yyDollar[1].tableExpr, Join: yyDollar[2].str, RightExpr: yyDollar[3].tableExpr, On: yyDollar[5].boolExpr}
		}
	case 76:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:528
		{
			yyVAL.bytes = nil
		}
	case 77:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:532
		{
			yyVAL.bytes = yyDollar[1].bytes
		}
	case 78:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:536
		{
			yyVAL.bytes = yyDollar[2].bytes
		}
	case 79:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:542
		{
			yyVAL.str = AST_JOIN
		}
	case 80:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:546
		{
			yyVAL.str = AST_STRAIGHT_JOIN
		}
	case 81:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:550
		{
			yyVAL.str = AST_LEFT_JOIN
		}
	case 82:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:554
		{
			yyVAL.str = AST_LEFT_JOIN
		}
	case 83:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:558
		{
			yyVAL.str = AST_RIGHT_JOIN
		}
	case 84:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:562
		{
			yyVAL.str = AST_RIGHT_JOIN
		}
	case 85:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:566
		{
			yyVAL.str = AST_JOIN
		}
	case 86:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:570
		{
			yyVAL.str = AST_CROSS_JOIN
		}
	case 87:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:574
		{
			yyVAL.str = AST_NATURAL_JOIN
		}
	case 88:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:580
		{
			yyVAL.smTableExpr = &TableName{Name: yyDollar[1].bytes}
		}
	case 89:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:584
		{
			yyVAL.smTableExpr = &TableName{Qualifier: yyDollar[1].bytes, Name: yyDollar[3].bytes}
		}
	case 90:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:588
		{
			yyVAL.smTableExpr = yyDollar[1].subquery
		}
	case 91:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:594
		{
			yyVAL.tableName = &TableName{Name: yyDollar[1].bytes}
		}
	case 92:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:598
		{
			yyVAL.tableName = &TableName{Qualifier: yyDollar[1].bytes, Name: yyDollar[3].bytes}
		}
	case 93:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:603
		{
			yyVAL.indexHints = nil
		}
	case 94:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:607
		{
			yyVAL.indexHints = &IndexHints{Type: AST_USE, Indexes: yyDollar[4].bytes2}
		}
	case 95:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:611
		{
			yyVAL.indexHints = &IndexHints{Type: AST_IGNORE, Indexes: yyDollar[4].bytes2}
		}
	case 96:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:615
		{
			yyVAL.indexHints = &IndexHints{Type: AST_FORCE, Indexes: yyDollar[4].bytes2}
		}
	case 97:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:621
		{
			yyVAL.bytes2 = [][]byte{yyDollar[1].bytes}
		}
	case 98:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:625
		{
			yyVAL.bytes2 = append(yyDollar[1].bytes2, yyDollar[3].bytes)
		}
	case 99:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:630
		{
			yyVAL.boolExpr = nil
		}
	case 100:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:634
		{
			yyVAL.boolExpr = yyDollar[2].boolExpr
		}
	case 102:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:641
		{
			yyVAL.boolExpr = &AndExpr{Left: yyDollar[1].boolExpr, Right: yyDollar[3].boolExpr}
		}
	case 103:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:645
		{
			yyVAL.boolExpr = &OrExpr{Left: yyDollar[1].boolExpr, Right: yyDollar[3].boolExpr}
		}
	case 104:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:649
		{
			yyVAL.boolExpr = &NotExpr{Expr: yyDollar[2].boolExpr}
		}
	case 105:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:653
		{
			yyVAL.boolExpr = &ParenBoolExpr{Expr: yyDollar[2].boolExpr}
		}
	case 106:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:659
		{
			yyVAL.boolExpr = &ComparisonExpr{Left: yyDollar[1].valExpr, Operator: yyDollar[2].str, Right: yyDollar[3].valExpr}
		}
	case 107:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:663
		{
			yyVAL.boolExpr = &ComparisonExpr{Left: yyDollar[1].valExpr, Operator: AST_IN, Right: yyDollar[3].tuple}
		}
	case 108:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:667
		{
			yyVAL.boolExpr = &ComparisonExpr{Left: yyDollar[1].valExpr, Operator: AST_NOT_IN, Right: yyDollar[4].tuple}
		}
	case 109:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:671
		{
			yyVAL.boolExpr = &ComparisonExpr{Left: yyDollar[1].valExpr, Operator: AST_LIKE, Right: yyDollar[3].valExpr}
		}
	case 110:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:675
		{
			yyVAL.boolExpr = &ComparisonExpr{Left: yyDollar[1].valExpr, Operator: AST_NOT_LIKE, Right: yyDollar[4].valExpr}
		}
	case 111:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:679
		{
			yyVAL.boolExpr = &RangeCond{Left: yyDollar[1].valExpr, Operator: AST_BETWEEN, From: yyDollar[3].valExpr, To: yyDollar[5].valExpr}
		}
	case 112:
		yyDollar = yyS[yypt-6 : yypt+1]
		//line kingshard/sqlparser/sql.y:683
		{
			yyVAL.boolExpr = &RangeCond{Left: yyDollar[1].valExpr, Operator: AST_NOT_BETWEEN, From: yyDollar[4].valExpr, To: yyDollar[6].valExpr}
		}
	case 113:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:687
		{
			yyVAL.boolExpr = &NullCheck{Operator: AST_IS_NULL, Expr: yyDollar[1].valExpr}
		}
	case 114:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:691
		{
			yyVAL.boolExpr = &NullCheck{Operator: AST_IS_NOT_NULL, Expr: yyDollar[1].valExpr}
		}
	case 115:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:695
		{
			yyVAL.boolExpr = &ExistsExpr{Subquery: yyDollar[2].subquery}
		}
	case 116:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:701
		{
			yyVAL.str = AST_EQ
		}
	case 117:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:705
		{
			yyVAL.str = AST_LT
		}
	case 118:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:709
		{
			yyVAL.str = AST_GT
		}
	case 119:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:713
		{
			yyVAL.str = AST_LE
		}
	case 120:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:717
		{
			yyVAL.str = AST_GE
		}
	case 121:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:721
		{
			yyVAL.str = AST_NE
		}
	case 122:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:725
		{
			yyVAL.str = AST_NSE
		}
	case 123:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:731
		{
			yyVAL.insRows = yyDollar[2].values
		}
	case 124:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:735
		{
			yyVAL.insRows = yyDollar[1].selStmt
		}
	case 125:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:741
		{
			yyVAL.values = Values{yyDollar[1].tuple}
		}
	case 126:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:745
		{
			yyVAL.values = append(yyDollar[1].values, yyDollar[3].tuple)
		}
	case 127:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:751
		{
			yyVAL.tuple = ValTuple(yyDollar[2].valExprs)
		}
	case 128:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:755
		{
			yyVAL.tuple = yyDollar[1].subquery
		}
	case 129:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:761
		{
			yyVAL.subquery = &Subquery{yyDollar[2].selStmt}
		}
	case 130:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:767
		{
			yyVAL.valExprs = ValExprs{yyDollar[1].valExpr}
		}
	case 131:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:771
		{
			yyVAL.valExprs = append(yyDollar[1].valExprs, yyDollar[3].valExpr)
		}
	case 132:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:777
		{
			yyVAL.valExpr = yyDollar[1].valExpr
		}
	case 133:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:781
		{
			yyVAL.valExpr = yyDollar[1].colName
		}
	case 134:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:785
		{
			yyVAL.valExpr = yyDollar[1].tuple
		}
	case 135:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:789
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_BITAND, Right: yyDollar[3].valExpr}
		}
	case 136:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:793
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_BITOR, Right: yyDollar[3].valExpr}
		}
	case 137:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:797
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_BITXOR, Right: yyDollar[3].valExpr}
		}
	case 138:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:801
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_PLUS, Right: yyDollar[3].valExpr}
		}
	case 139:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:805
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_MINUS, Right: yyDollar[3].valExpr}
		}
	case 140:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:809
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_MULT, Right: yyDollar[3].valExpr}
		}
	case 141:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:813
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_DIV, Right: yyDollar[3].valExpr}
		}
	case 142:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:817
		{
			yyVAL.valExpr = &BinaryExpr{Left: yyDollar[1].valExpr, Operator: AST_MOD, Right: yyDollar[3].valExpr}
		}
	case 143:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:821
		{
	...
	case 144:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:836
		{
			yyVAL.valExpr = &FuncExpr{Name: yyDollar[1].bytes}
		}
	case 145:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:840
		{
			yyVAL.valExpr = &FuncExpr{Name: yyDollar[1].bytes, Exprs: yyDollar[3].selectExprs}
		}
	case 146:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:844
		{
			yyVAL.valExpr = &FuncExpr{Name: yyDollar[1].bytes, Distinct: true, Exprs: yyDollar[4].selectExprs}
		}
	case 147:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:848
		{
			yyVAL.valExpr = &FuncExpr{Name: yyDollar[1].bytes, Exprs: yyDollar[3].selectExprs}
		}
	case 148:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:852
		{
			yyVAL.valExpr = yyDollar[1].caseExpr
		}
	case 149:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:858
		{
			yyVAL.bytes = IF_BYTES
		}
	case 150:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:862
		{
			yyVAL.bytes = VALUES_BYTES
		}
	case 151:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:868
		{
			yyVAL.byt = AST_UPLUS
		}
	case 152:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:872
		{
			yyVAL.byt = AST_UMINUS
		}
	case 153:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:876
		{
			yyVAL.byt = AST_TILDA
		}
	case 154:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:882
		{
			yyVAL.caseExpr = &CaseExpr{Expr: yyDollar[2].valExpr, Whens: yyDollar[3].whens, Else: yyDollar[4].valExpr}
		}
	case 155:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:887
		{
			yyVAL.valExpr = nil
		}
	case 156:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:891
		{
			yyVAL.valExpr = yyDollar[1].valExpr
		}
	case 157:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:897
		{
			yyVAL.whens = []*When{yyDollar[1].when}
		}
	case 158:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:901
		{
			yyVAL.whens = append(yyDollar[1].whens, yyDollar[2].when)
		}
	case 159:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:907
		{
			yyVAL.when = &When{Cond: yyDollar[2].boolExpr, Val: yyDollar[4].valExpr}
		}
	case 160:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:912
		{
			yyVAL.valExpr = nil
		}
	case 161:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:916
		{
			yyVAL.valExpr = yyDollar[2].valExpr
		}
	case 162:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:922
		{
			yyVAL.colName = &ColName{Name: yyDollar[1].bytes}
		}
	case 163:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:926
		{
			yyVAL.colName = &ColName{Qualifier: yyDollar[1].bytes, Name: yyDollar[3].bytes}
		}
	case 164:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:930
		{
			yyVAL.colName = &ColName{Qualifier: yyDollar[3].bytes, Name: yyDollar[5].bytes}
		}
	case 165:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:936
		{
			yyVAL.valExpr = StrVal(yyDollar[1].bytes)
		}
	case 166:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:940
		{
			yyVAL.valExpr = NumVal(yyDollar[1].bytes)
		}
	case 167:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:944
		{
			yyVAL.valExpr = ValArg(yyDollar[1].bytes)
		}
	case 168:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:948
		{
			yyVAL.valExpr = &NullVal{}
		}
	case 169:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:953
		{
			yyVAL.valExprs = nil
		}
	case 170:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:957
		{
			yyVAL.valExprs = yyDollar[3].valExprs
		}
	case 171:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:962
		{
			yyVAL.boolExpr = nil
		}
	case 172:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:966
		{
			yyVAL.boolExpr = yyDollar[2].boolExpr
		}
	case 173:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:971
		{
			yyVAL.orderBy = nil
		}
	case 174:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:975
		{
			yyVAL.orderBy = yyDollar[3].orderBy
		}
	case 175:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:981
		{
			yyVAL.orderBy = OrderBy{yyDollar[1].order}
		}
	case 176:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:985
		{
			yyVAL.orderBy = append(yyDollar[1].orderBy, yyDollar[3].order)
		}
	case 177:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:991
		{
			yyVAL.order = &Order{Expr: yyDollar[1].valExpr, Direction: yyDollar[2].str}
		}
	case 178:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:996
		{
			yyVAL.str = AST_ASC
		}
	case 179:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1000
		{
			yyVAL.str = AST_ASC
		}
	case 180:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1004
		{
			yyVAL.str = AST_DESC
		}
	case 181:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1009
		{
			yyVAL.limit = nil
		}
	case 182:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:1013
		{
			yyVAL.limit = &Limit{Rowcount: yyDollar[2].valExpr}
		}
	case 183:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:1017
		{
			yyVAL.limit = &Limit{Offset: yyDollar[2].valExpr, Rowcount: yyDollar[4].valExpr}
		}
	case 184:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:1021
		{
			yyVAL.limit = &Limit{Offset: yyDollar[4].valExpr, Rowcount: yyDollar[2].valExpr}
		}
	case 185:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1026
		{
			yyVAL.str = ""
		}
	case 186:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:1030
		{
			yyVAL.str = AST_FOR_UPDATE
		}
	case 187:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line kingshard/sqlparser/sql.y:1034
		{
	...
	case 188:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1047
		{
			yyVAL.columns = nil
		}
	case 189:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:1051
		{
			yyVAL.columns = yyDollar[2].columns
		}
	case 190:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1057
		{
			yyVAL.columns = Columns{&NonStarExpr{Expr: yyDollar[1].colName}}
		}
	case 191:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:1061
		{
			yyVAL.columns = append(yyVAL.columns, &NonStarExpr{Expr: yyDollar[3].colName})
		}
	case 192:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1066
		{
			yyVAL.updateExprs = nil
		}
	case 193:
		yyDollar = yyS[yypt-5 : yypt+1]
		//line kingshard/sqlparser/sql.y:1070
		{
			yyVAL.updateExprs = yyDollar[5].updateExprs
		}
	case 194:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1076
		{
			yyVAL.updateExprs = UpdateExprs{yyDollar[1].updateExpr}
		}
	case 195:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:1080
		{
			yyVAL.updateExprs = append(yyDollar[1].updateExprs, yyDollar[3].updateExpr)
		}
	case 196:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:1086
		{
			yyVAL.updateExpr = &UpdateExpr{Name: yyDollar[1].colName, Expr: yyDollar[3].valExpr}
		}
	case 197:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:1090
		{
			yyVAL.updateExpr = &UpdateExpr{Name: yyDollar[1].colName, Expr: StrVal("ON")}
		}
	case 198:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1095
		{
			yyVAL.empty = struct{}{}
		}
	case 199:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:1097
		{
			yyVAL.empty = struct{}{}
		}
	case 200:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1100
		{
			yyVAL.empty = struct{}{}
		}
	case 201:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line kingshard/sqlparser/sql.y:1102
		{
			yyVAL.empty = struct{}{}
		}
	case 202:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1105
		{
			yyVAL.str = ""
		}
	case 203:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1107
		{
			yyVAL.str = AST_IGNORE
		}
	case 204:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1111
		{
			yyVAL.empty = struct{}{}
		}
	case 205:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1113
		{
			yyVAL.empty = struct{}{}
		}
	case 206:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1115
		{
			yyVAL.empty = struct{}{}
		}
	case 207:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1117
		{
			yyVAL.empty = struct{}{}
		}
	case 208:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1119
		{
			yyVAL.empty = struct{}{}
		}
	case 209:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1122
		{
			yyVAL.empty = struct{}{}
		}
	case 210:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1124
		{
			yyVAL.empty = struct{}{}
		}
	case 211:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1127
		{
			yyVAL.empty = struct{}{}
		}
	case 212:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1129
		{
			yyVAL.empty = struct{}{}
		}
	case 213:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1132
		{
			yyVAL.empty = struct{}{}
		}
	case 214:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line kingshard/sqlparser/sql.y:1134
		{
			yyVAL.empty = struct{}{}
		}
	case 215:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1138
		{
			yyVAL.bytes = bytes.ToLower(yyDollar[1].bytes)
		}
	case 216:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1143
		{
			ForceEOF(yylex)
		}
	case 217:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line kingshard/sqlparser/sql.y:1148
		{
			yyVAL.str = ""
		}
	case 218:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line kingshard/sqlparser/sql.y:1152
		{
			yyVAL.str = AST_TABLE
		}
	}
